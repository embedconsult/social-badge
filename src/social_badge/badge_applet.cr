...
module SocialBadge
  class BadgeApplet < Lvgl::Applet
    ...
    def setup(screen : Lvgl::Object = Lvgl::Object.screen_active)
      ...
      @header_label.not_nil!.align(Lvgl::Align::TopLeft, offset: {8, HEADER_Y})
      ...
      @status_label.not_nil!.align(Lvgl::Align::TopLeft, offset: {8, STATUS_Y})
      ...
      TIMELINE_LIMIT.times do |idx|
        ...
        row.align(Lvgl::Align::TopLeft, offset: {8, TIMELINE_START + (idx * TIMELINE_ROW_H)})
        row.text = ""
        @rows << row
      end
